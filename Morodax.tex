...
\input{MACROS_Character_Sheet.tex}
\input{MACROS_Equip.tex}

\title{System Morodax}

\input{Character_Sheet.tex}
\tableofcontents\newpage
\input{Welt.tex}
...
\part{Anhang}
\begin{Beispiele}
%\input{WaffenRüstungen.tex}
\input{AnhangGegenstände.tex}
\input{AnhangZauber.tex}
%\input{AnhangManover.tex}
\end{Beispiele}
\begin{characterSheets}
\input{MACROS_Character_Sheet_Setup.tex}
\input{Monster.tex}
